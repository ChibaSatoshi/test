...
<body>
	...
	<div id="main">
		...
		<div>
			<h3>追加する内容は以下でよろしいですか。</h3>
			<table>
				<s:form action="ItemCreateCompleteAction">
				<tr>
					<td><label>商品名</label></td>
					<td><s:property value="itemCreate_name" escape="false"/></td>
				</tr>
				<tr>
					<td><label>値段</label></td>
					<td><s:property value="itemCreate_price" escape="false"/><span>円</span></td>
				</tr>
				<tr>
					<td><label>在庫数</label></td>
					<td><s:property value="itemCreate_stock" escape="false"/><span>個</span></td>
				</tr>
				</s:form>
				<tr>
